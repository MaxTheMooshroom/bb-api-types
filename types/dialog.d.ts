...
type InputFormConfig = { [formElement: string]: '_' | FormElement };
...
interface DialogOptions {
  ...
  lines?: (
    | HTMLElement
    | Comment
    | { label?: string; widget?: Widget | (() => Widget); nocolon?: boolean }
    | string
  )[];
  /**
...
interface DialogSidebarOptions {
  pages?: { [key: string]: string | { label: string; icon: IconString; color?: string } };
  page?: string;
...
declare class Dialog {
   ...
   */
  getFormResult(): { [key: string]: FormResultValue };
  /**
   * Function to execute when the dialog is opened
   */
  onOpen?(): void;
