...
declare class ModelProject {
  ...
  static properties: { [key: string]: Property<any> };
  ...
  mesh_selection: {
    [element_key: string]: { vertices: string[]; edges: string[]; faces: string[] };
  };
  selected_faces: any[];
  textures: Texture[];
  ...
  tool: string;
  uv_viewport: { zoom: number; offset: [number, number]; [key: string]: any };
  ...
  get nodes_3d(): { [uuid: UUID]: THREE.Object3D };
