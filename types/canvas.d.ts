...
declare namespace Canvas {
  const materials: { [uuid: UUID]: THREE.Material };
  const emptyMaterials: { [uuid: UUID]: THREE.Material };
  const meshes: { [uuid: UUID]: THREE.Mesh };
  const bones: { [uuid: UUID]: THREE.Object3D };
  /**
...
declare class NodePreviewController {
  ...
  events: { [event_name: string]: ((data: any) => void)[] };
  mesh: THREE.Object3D | THREE.Mesh;
