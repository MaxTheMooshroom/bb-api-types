...
interface MessageBoxOptions {
  ...
  commands?: {
    [id: string]:
      | string
      | { text: string; icon?: IconString; condition?: ConditionResolvable; description?: string };
  };
  /**
   * Adds checkboxes to the bottom of the message box
   */
  checkboxes?: {
    [id: string]: string | { value?: boolean; condition: ConditionResolvable; text: string };
  };
}
...
declare const Pressing: {
  ...
  ctrl: boolean;
  alt: boolean;
  overrides: { shift: boolean; ctrl: boolean; alt: boolean };
};
