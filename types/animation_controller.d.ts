...
type StateAnimationInput =
  | string
  | { [key: string]: string }
  | { uuid: string; key?: string; animation?: string; blend_value?: number };
type StateAnimation = { uuid: string; key: string; animation: string; blend_value: number };
...
declare class AnimationControllerState {
  ...
  muted: { sound: boolean; particle: boolean };
