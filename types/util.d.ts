...
declare function getRectangle(
  ...
  c: any,
  d: any,
): { ax: any; ay: any; bx: any; by: any; x: number; w: number; y: number; h: number };
...
declare function intToRGBA(int: any): { r: number; g: number; b: number; a: number };
declare function getAverageRGB(imgEl: any, blockSize: any): { r: number; g: number; b: number };
